...
After Assignment1.04 connected add flow to Redux, delete remained a no-op callback. This step completes core students CRUD interaction expected for Session 3-style Redux integration and enables proper action-based debugging/time-travel.
...
- Superseded for Lab 2 indexing: use `HistoryVersions/Assignment2/Assignment2.03.md` as the canonical record.
