...
After completing read-only store integration in Assignment1.03, the next incremental Session 3 step is to connect user input to Redux actions so the action log and state updates appear in Redux DevTools.
...
- Superseded for Lab 2 indexing: use `HistoryVersions/Assignment2/Assignment2.02.md` as the canonical record.
