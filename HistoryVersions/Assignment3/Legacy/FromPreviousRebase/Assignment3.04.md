...
Validated Lab 2 Redux interaction flow in the running app (add and delete) and corrected Lab 2 history placement/versioning into the proper Assignment3 folder sequence.

## Reason

Lab 2 work was previously recorded under Assignment1.02-Assignment1.05. Per repository versioning rules, Lab 2 must start at Assignment3.00. This update fixes audit structure and captures a fresh verification pass.

## Changes

1. Added HistoryVersions/Assignment3/Assignment3.00.md
   - Rebased prior Lab 2 migration baseline record from Assignment1.02.
   - Corrected title to Assignment3.00.

2. Added HistoryVersions/Assignment3/Assignment3.01.md
   - Rebased prior Redux read-only selector integration from Assignment1.03.
   - Corrected title to Assignment3.01.

3. Added HistoryVersions/Assignment3/Assignment3.02.md
   - Rebased prior addStudent dispatch integration from Assignment1.04.
   - Corrected title to Assignment3.02.
   - Corrected previous-version reference from Assignment1.03 to Assignment3.01.

4. Added HistoryVersions/Assignment3/Assignment3.03.md
   - Rebased prior deleteStudent dispatch integration from Assignment1.05.
   - Corrected title to Assignment3.03.
   - Corrected previous-version reference from Assignment1.04 to Assignment3.02.
