...
After completing read-only store integration in Assignment3.01, the next incremental Session 3 step is to connect user input to Redux actions so the action log and state updates appear in Redux DevTools.
